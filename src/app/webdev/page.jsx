      ...
      <header className="header" ref={heroRef}>
        ...
        >
          ...
          <h1 className="main-heading">
            <span className="animate-text word-effect delay-1">Web Design & {""}</span>
      ...
      <section className="intro-section">
        <div className="content-container">
          ...
          <p className="section-text animate-text fade-up delay-1">
            ...
            At Soulsoft Infotech, we specialize in web design & development that creates 
            visually stunning, high-performing, and mobile-friendly websites tailored to 
            your business needs.
          </p>
